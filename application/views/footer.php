	...
	<div class="container">
		<div class="col-md-2 span_2">
			...
			<ul class="list1">
				...
				<li><a href="#">Enterprise Features</a>
				</li>
				<li><a href="#">Why Us?</a>
				</li>
		...
		<div class="col-md-6 span_3 wow fadeInRight" data-wow-delay="0.4s">
			...
			<ul class="list2">
				<i class="msg"> </i>
				<li class="phone_desc">
					<p><a href="mailto:info@demo.com"> info(at)protectly.com</a>
					</p>
				</li>
				<div class="clearfix"> </div>
			</ul>
			<p class="copy">&copy;2015 Template by <a href="http://w3layouts.com" target="_blank">w3layouts</a>
			</p>
		</div>
	</div>
</div>